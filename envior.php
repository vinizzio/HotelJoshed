...
$mensaje .= "Tipo de habitacion: " . $tipo . " \r\n";
$mensaje .= "Num. personas adultas: " . $persona . " \r\n";
$mensaje .= "Num. niños: " . $persona3 . " \r\n";
$mensaje .= "Num. dias: " . $dias . " \r\n";
$mensaje .= "Fecha de ingreso: " . $fecha . " \r\n";
$mensaje .= "Fecha de salida: " . $fecha3 . " \r\n";
$mensaje .= "Num. de contacto: " . $contacto . " \r\n";
$mensaje .= "mail: " . $mail . " \r\n";
$mensaje .= "Mensaje: " . $men . " \r\n";
$mensaje .= "Enviado el " . date('d/m/Y', time());
$mensaje .= "Mensaje enviado del formulario Reservaciones - Hotel Joshed Imperial.";

$para = 'madelosangeles_ed@hotmail.com,hoteljoshed@hotmail.com';
$asunto = 'Hotel Joshed - Reservación';
  ...
  <div id="main">
    ...
    <div id="site_content">
      ...
      <div id="content">
        ...
        <h1>Su mensaje fue enviado con exito...</h1>
